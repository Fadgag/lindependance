...
// Use runtime require to avoid TS type dependency on '@playwright/test' in environments
// where dev deps may not be installed (pre-commit hooks). The test still runs with Node.
// @ts-ignore
