...
INSERT INTO "new_Appointment" ("createdAt", "customerId", "customerPackageId", "duration", "endTime", "extras", "finalPrice", "id", "organizationId", "paymentMethod", "serviceId", "staffId", "startTime", "status", "title", "updatedAt") SELECT "createdAt", "customerId", "customerPackageId", "duration", "endTime", "extras", "finalPrice", "id", "organizationId", "paymentMethod", "serviceId", "staffId", "startTime", "status", "title", "updatedAt" FROM "Appointment";
